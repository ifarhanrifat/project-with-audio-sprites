...
<html lang="en" class="broken-image-checker">
  ...
  <div id="body-wrapper">
	...
	<header>
	<section class="hdr-top hdr-nav hdr--sticky cross-toggle">
		<div class="container">
			  ...
			  <div class="container-fluid">
				...
				<div id="slidemenu">
					<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					  <ul class="nav navbar-nav navbar-main navbar-move navbar-right pul-rgt">
						<li>
							<a href="#"><i class="fa fa-info-circle"></i> About</a>
						</li>
						<li>
							<a href="#"><i class="fa fa-phone-square"></i> Contact</a>
						</li>
						<li class="dropdown-toggle">
							<a href="#" data-toggle="dropdown"><i class="fa fa-sign-in"></i> Hello, Log In<b class="caret"></b></a>
							<ul class="dropdown-menu multi-level">
								 <li><a href="#"><i class="fa fa-user"></i> Agency Log In</a></li>
								 <li><a href="#"><i class="fa fa-child"></i> Trainee Log In</a></li>
								 <li><a href="#"><i class="fa fa-user-md"></i> Nurse Log In</a></li>
							</ul>
						</li> 
					  </ul>
					</div><!-- /.navbar-collapse -->
			  ...
			  <div class="container-fluid">
				...
				<div class="navbar-header">
				  <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1">
					...
					<a class="navbar-brand" href="index.html"><img src="images/itrainLogo.png" alt="logo" class="broken-image"/></a>
				</div>
